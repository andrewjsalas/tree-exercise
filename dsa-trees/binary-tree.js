...
class BinaryTree {
  ...
  areCousins(node1, node2) {
    ...
    function findLevelAndParent(nodeToFind, currentNode, level = 0, data = { level: 0, parent: null }
      ...
      if (currentNode.left) {
        findLevelAndParent(nodeToFind, currentNode.left, left + 1, data);
      }

      if (currentNode.right) {
        findLevelAndParent(nodeToFind, currentNode.right, right + 1, data);
      }
    ...
    let differentParents = node1Info && node2Info && node1Info.level !== node2Info.level;
